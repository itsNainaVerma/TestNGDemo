...
/* Method test2_openOrangeHRM() will fail. Since this method is opening the application, 
 * rest of the Test methods dpends on it. but there is no dependency mention on with Test annotations
 * so all Test methods will run and get failed.
 * in such scenarios dependency testing is required. see DependOnMethods_Fail.java for more info
 */
...
public class No_DependsOnMethod {
